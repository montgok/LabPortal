$(document).ready(function(){
  ...
  function doSubmit(){
    ...
    if($("table.sortable_simple_col3sorted").length > 0)
        $("table.sortable_simple_col3sorted").dataTable({"aaSorting": [[ 2, "desc" ]],"iDisplayLength": 5,"bLengthChange": false,"bFilter": false,"bInfo": false,"bPaginate": true});
    ...
    if($("table.sortable").length > 0)
        $("table.sortable").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [null, null, null, null]});    
    /* eof Datatables */
